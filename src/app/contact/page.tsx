      ...
      <div className="max-w-3xl mx-auto space-y-8">
        <Card className="shadow-lg">
          ...
          <CardContent className="space-y-4">
            ...
            <InfoRow label="Email">
               <a href="mailto:inbox.lyra@gmail.com" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline flex items-center">inbox.lyra@gmail.com <Mail className="h-5 w-5 ml-2" /></a>
            </InfoRow>
