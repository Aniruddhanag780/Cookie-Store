        ...
        <Card className="shadow-lg">
          ...
          <CardContent className="space-y-4">
            ...
            <InfoRow label="WhatsApp">
              <a href="https://wa.me/916296731835" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline flex items-center">
                Click Here to Message Us <WhatsAppIcon />
              </a>
            </InfoRow>
            <InfoRow label="Email">
               <a href="mailto:inbox.lyra@gmail.com" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline flex items-center">Click Here to Send Us Email <Mail className="h-5 w-5 ml-2" /></a>
            </InfoRow>
