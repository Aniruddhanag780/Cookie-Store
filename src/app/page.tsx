...
const serviceCards = [
  {
    ...
    description: 'Our breads are made daily from scratch using traditional methods and the finest ingredients.',
    imageHint: 'artisan bread',
  },
  {
    id: 'sweet-pastries',
    title: 'Sweet Pastries',
    description: 'Indulge in our wide selection of sweet pastries, from flaky croissants to rich Danishes.',
    imageHint: 'sweet pastry',
  },
  {
    id: 'custom-cakes',
    title: 'Custom Cakes',
    description: 'Celebrate your special moments with a custom-designed cake, tailored to your taste.',
...
export default function Home() {
  ...
  return (
    <div className="flex flex-col gap-16 md:gap-24">
      <section className="relative h-[70dvh] md:h-[80dvh] w-full">
        {heroImage && (
          <Image
      ...
      >
        <div className="animate-fade-in opacity-0 text-center">
          ...
          <p className="max-w-2xl mx-auto text-muted-foreground mb-12">
            We are dedicated to providing the best tasting, highest quality baked goods. Our commitment to freshness and flavor is unmatched.
          </p>
        ...
        <div className="animate-fade-in opacity-0 grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
                 ...
                 <p className="text-muted-foreground text-lg">
                    Experience the aroma of freshly baked goods and enjoy a cup of our signature coffee. Our cozy bakery is the perfect place to relax and treat yourself.
                 </p>
             ...
             <div className="grid grid-cols-2 gap-4">
                {visitImage1 && (
                    <div className="relative aspect-square">
                        <Image src={visitImage1.imageUrl} alt={visitImage1.description} fill className="object-cover rounded-lg" data-ai-hint={visitImage1.imageHint} />
                    </div>
                )}
                 {visitImage2 && (
                    <div className="relative aspect-square">
                        <Image src={visitImage2.imageUrl} alt={visitImage2.description} fill className="object-cover rounded-lg" data-ai-hint={visitImage2.imageHint} />
                    </div>
                )}
            </div>
        </div>
